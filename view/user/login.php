  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url()?>user/login"><b>TrackFitness</b>Customer</a>
      </div><!-- /.login-logo -->
      ...
      <?php echo SessionHelper::flashMessage();  ?>
        ...
        <a href="<?php echo base_url()?>user/forgot">I forgot my password</a><br><br>

        <a href="<?php echo base_url()?>user/signup">Don't have an account? Sign Up</a><br>
